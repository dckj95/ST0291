		...
		<div class="row" id="bottom">
			...
			<article class="col-md-7 maincontent">
				<header class="page-header">
					<h1 class="page-title">Delete Flight Schedule Confirmation</h1>
				</header>
				...
				<strong>Are you sure you want to delete this flight schedule?</strong><br>
				
				<!-- Form START -->
				<form action="DeleteFlightSchedule" method="post">
