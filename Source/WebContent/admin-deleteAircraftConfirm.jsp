...
<html lang="en">
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Delete Aircraft</li>
		</ol>
		...
		<div class="row" id="bottom">
			...
			<article class="col-md-7 maincontent">
				...
				<strong>Are you sure you want to delete this aircraft?</strong><br>
				All flight schedules for this aircraft will be deleted as well.
