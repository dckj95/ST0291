	...
	<div class="container">
		...
		<div class="row" id="bottom">
			...
			<article class="col-md-5 maincontent">
				...
				<!-- Form START -->
				<form action="AddNewAircraft" method="post" enctype="multipart/form-data">
					<table class="adminFixed">
						...
						<tr>
							<td>Flight Number:</td>
							<td><input type="text" name="flightNum" placeholder="SP 20" pattern="^SP\s\d{2,3}$" required></td>
						</tr>
						<tr>
							<td><br></td>
						</tr>
						<tr>
							...
							<td><input type="text" name="economyCap" pattern="^\d+$" required></td>
						</tr>
						<tr>
							<td>Business Class Capacity:</td>
							<td><input type="text" name="businessCap" pattern="^\d+$" required></td>
						</tr>
						<tr>
							<td>First Class Capacity:</td>
							<td><input type="text" name="firstCap" pattern="^\d+$"></td>
						</tr>
						<tr>
							<td><br></td>
						</tr>
						<tr>
							...
							<td><input type="file" accept="image/jpeg" name="economyImage" required></td>
						</tr>
						<tr>
							<td>Business Seat Layout:</td>
							<td><input type="file" accept="image/jpeg" name="businessImage" required></td>
						</tr>
						<tr>
