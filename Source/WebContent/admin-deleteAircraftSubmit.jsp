...
<html lang="en">
	...
	<head>
		...
		<title>SP Airlines | Admin Dashboard | Delete Aircraft</title>
		...
		<div class="row" id="bottom">
					...
					<div class="col-xs-12">
						...
						<form id="sideLinks">
							...
							<fieldset>
								...
								<table class="fixed">
									<tr>
										<td><a href="admin-deleteAircraft.jsp"><img src="images/icons/aircraft-active.png" alt="Delete Aircraft"></a></td>
			...
			<article class="col-md-5 maincontent">
				<header class="page-header">
					<h1 class="page-title">Delete Aircraft</h1>
				</header>
				...
				<%
					...
					if (request.getAttribute("result") != null) {
						...
						out.println("Success!<br>" + rec + " aircraft was deleted.<br><a href='admin-deleteAircraft.jsp'>Click here</a> to delete more aircrafts.");
						System.out.println(Misc.getDate() + "Delete Aircraft success");
						
					} else {
						
						out.println("An unknown error has occured.<br><a href='admin-deleteAircraft.jsp'>Click here</a> to try again.");
						System.out.println(Misc.getDate() + "Delete Aircraft failed");
