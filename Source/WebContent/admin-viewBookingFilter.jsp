...
<html lang="en">
		...
		<div class="row" id="bottom">
			...
			<article class="col-md-7 maincontent">
				...
				<%
					...
					String flightNumChooser = DBSearch.generateFSChooser("flightNum");
				...
				<form action="ViewBooking" method="post" id="fsFilterForm">
					...
					<table id="fsFilter">
						...
						<tr>
							...
							<td id="fsFilterLeft">
									<input id="fsFilter-flightNum" type="radio" name="fsFilter" value="fsFilter-flightNum">
									<label for="fsFilter-flightNum">Flight Number</label>
									<br>
							...
							<td colspan="3" id="fsFilterRight">
								<div class="fsFilterDiv" id="fsFilterDiv-flightNum">
									Select a flight number:<br>
	...
	<script src="js/initBookingFilter.js"></script>
