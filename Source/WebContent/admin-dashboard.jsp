...
<html lang="en">
	...
	<head>
		...
		<title>SP Airlines | Admin Dashboard</title>
		...
		<div class="row" id="bottom">
			...
			<article class="col-md-7 maincontent">
				...
				<%
					...
					int aircraftCount = 0;
					int flightscheduleCount = 0;
					int userCount = 0;
					
					try {

						aircraftCount = DBSearch.generateAdminStats("aircraft");
						flightscheduleCount = DBSearch.generateAdminStats("flightschedule");
						userCount = DBSearch.generateAdminStats("user");
					
						System.out.println(Misc.getDate() + "Admin stats generated");
						
					} catch (Exception e) {
						System.out.println(Misc.getDate() + "Admin stats generation failed");
					}
					
				%>
				
				<h6>
					In the database, there are:<br>
					<strong><%=aircraftCount%></strong> aircrafts<br>
					<strong><%=flightscheduleCount%></strong> flight schedules<br>
					<strong><%=userCount%></strong> user accounts
				</h6>
