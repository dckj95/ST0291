			...
			<article class="col-md-5 maincontent">
				...
				<%
					...
					if (request.getAttribute("result") != null) {
						...
						out.println("Success!<br>" + rec + " flight schedule was deleted.<br><a href='admin-deleteFlightSchedule.jsp'>Click here</a> to delete more flight schedules.");
						System.out.println(Misc.getDate() + "Delete Flight Schedule success");
						
					} else {
						
						out.println("An unknown error has occured.<br><a href='admin-deleteFlightSchedule.jsp'>Click here</a> to try again.");
						System.out.println(Misc.getDate() + "Delete Flight Schedule failed");
