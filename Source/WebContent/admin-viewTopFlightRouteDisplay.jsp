...
<html lang="en">
	...
	<head>
		...
		<title>SP Airlines | Admin Dashboard | View Top Flight Route</title>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li class="active">View Top Flight Route</li>
		</ol>
		...
		<div class="row" id="bottom">
							...
							<fieldset>
								...
								<table class="fixed">
									<tr>
										...
										<td><a href="admin-viewTopFlightRoute.jsp"><img src="images/icons/top-active.png" alt="View Top Flight Route"></a></td>
									</tr>
									<tr>
										<td>View Bookings</td>
			...
			<article class="col-md-7 maincontent">
				<header class="page-header">
					<h1 class="page-title">View Top Flight Route</h1>
				</header>
				...
				<table>
					...
					<%
						...
						if (request.getAttribute("result") != null) {
							...
							int year = Integer.parseInt(request.getParameter("yearChooser"));
							int i = 1;
							ArrayList<Route> alRoute = (ArrayList<Route>) request.getAttribute("result");
							
							out.println("Top flight routes for " + year + ":<br><br>");
							out.println("<table class='searchResults'>");
					
							out.println("<tr class='breakRow'>");
							out.println("<td><strong>Ranking</strong></td>");
							out.println("<td colspan='3'><strong>Departure</strong></td>");
							out.println("<td colspan='3'><strong>Arrival</strong></td>");
							out.println("<td><strong>Number of bookings</strong></td>");
							out.println("</tr>");
							...
							for (Route r:alRoute) {
								...
								out.println("<tr class='breakRow'>");
								out.println("<td>" + i + "</td>");
								out.println("<td colspan='3'>" + r.getDepartCity() + ", " + r.getDepartCountry() + "</td>");
								out.println("<td colspan='3'>" + r.getArriveCity() + ", " + r.getArriveCountry() + "</td>");
								out.println("<td>" + r.getCount() + "</td>");
								out.println("</tr>");
							...
							out.println("No flights routes were found.<br><a href='admin-viewTopFlightRoute.jsp'>Click here</a>to try again");
						}
