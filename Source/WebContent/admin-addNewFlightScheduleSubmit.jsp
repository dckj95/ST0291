			...
			<article class="col-md-5 maincontent">
				...
				<%
					...
					if (request.getAttribute("result") != null) {
						...
						out.println("Success!<br>" + rec + " new flight schedule was added to the database.<br><a href='admin-addNewFlightSchedule.jsp'>Click here</a> to add more flight schedules.");
						System.out.println(Misc.getDate() + "Add New Flight Schedule success");
						
					} else {
						
						out.println("An unknown error has occured.<br><a href='admin-addNewFlightSchedule.jsp'>Click here</a> to try again.");
						System.out.println(Misc.getDate() + "Add New Flight Schedule failed");		
