...
<html lang="en">
	...
	<head>
		...
		<title>SP Airlines | Admin Dashboard | Modify Aircraft Submit</title>
			...
			<article class="col-md-5 maincontent">
				...
				<%
					...
					if (request.getAttribute("result") != null) {
						...
						out.println("Success!<br>" + rec + " aircraft was modified.<br><a href='admin-modifyAircraft.jsp'>Click here</a> to modify more aircrafts.");
						System.out.println(Misc.getDate() + "Modify Aircraft success");
						
					} else {
						
						out.println("An unknown error has occured.<br><a href='admin-modifyAircraft.jsp'>Click here</a> to try again.");
						System.out.println(Misc.getDate() + "Modify Aircraft failed");
