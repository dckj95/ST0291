			...
			<article class="col-md-5 maincontent">
				...
				<%
					...
					if (request.getAttribute("result") != null) {
						...
						out.println("Success!<br>" + rec + " flight schedule was modified.<br><a href='admin-modifyFlightScheduleFilter.jsp'>Click here</a> to modify more flight schedules.");
						System.out.println(Misc.getDate() + "Modify Flight Schedule success");
						
					} else {
						
						out.println("An unknown error has occured.<br><a href='admin-modifyFlightScheduleFilter.jsp'>Click here</a> to try again.");
						System.out.println(Misc.getDate() + "Modify Flight Schedule failed");
